    ...
    <div class="section">
        <div class="container">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <select class="input-control" name="pelaporan" required>
                        <option value="">--pilih pelaporan--</option>
                        <?php
                        $ia = mysqli_query($conn, "SELECT * FROM input_aspirasi ORDER BY id_pelaporan DESC");
                        while ($inputa = mysqli_fetch_array($ia)) {
                            ?>
                            <option value="<?php echo $inputa['id_pelaporan'] ?> "><?php echo $inputa['id_pelaporan'] ?></option>
                        <?php } ?>
                </select>
