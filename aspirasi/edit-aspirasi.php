...
$aspirasi = mysqli_query($conn, "SELECT * FROM aspirasi LEFT JOIN input_aspirasi USING (id_pelaporan) WHERE id_aspirasi = '" . $_GET['id'] . "' ");
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                ...
                <input type="text" name="idp" class="input-control" placeholder="id pelaporan" value="id pelaporan : <?php echo $a->id_pelaporan ?> | nis : <?php echo $a->nis ?>" readonly>
